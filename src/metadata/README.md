 ...
 * [ecao.yml](ecao.yml)
     * Determines how your purl.obolibrary.org/obo/ecao/ redirects will be handled
     ...
     * Paste in the contents of [ecao.yml](ecao.yml)
 ...
 * [ecao.md](ecao.md)
     ...
     * Paste in the contents of [ecao.md](ecao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
